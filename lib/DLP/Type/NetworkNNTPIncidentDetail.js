...
var className = 'TypeNetworkNNTPIncidentDetail';

var TypeNetworkNNTPIncidentDetail = function (json, parentObj) {
...
module.exports = TypeNetworkNNTPIncidentDetail;
Modeler.register(TypeNetworkNNTPIncidentDetail, 'TypeNetworkNNTPIncidentDetail');
