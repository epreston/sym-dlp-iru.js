...
var className = 'TypeIncidentExportType';

var TypeIncidentExportType = function (json, parentObj) {
...
module.exports = TypeIncidentExportType;
Modeler.register(TypeIncidentExportType, 'TypeIncidentExportType');
