...
var className = 'TypeNetworkIncidentDetailType';

var TypeNetworkIncidentDetailType = function (json, parentObj) {
...
module.exports = TypeNetworkIncidentDetailType;
Modeler.register(TypeNetworkIncidentDetailType, 'TypeNetworkIncidentDetailType');
